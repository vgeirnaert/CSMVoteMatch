...
<div class="row rounded">
	...
	<div class="span9 coverview rounded">
		<h2>Statements</h2>
		<b>Part 1 of 2: </b> Please answer your stance on the following statements. In addition to the answers you can set the importance of each issue (higher score is more important, lower score is less important) and you can add a comment explaining your answer.
		<table>
			<tr class="header">
				<th></th>
...
Questions::initOKCQuestions(true);
Questions::printClassicQuestionTable(true);
?>
		</table>
	</div>
